...
当我们特别谈论到顶点着色器的时候，每个输入变量也叫$\color{green}{顶点属性}$(Vertex Attribute)。我们能声明的顶点属性是有上限的，它一般由硬件来决定。OpenGL确保至少有16个包含4分量的顶点属性可用，但是有些硬件或许允许更多的顶点属性，你可以查询GL_MAX_VERTEX_ATTRIBS来获取具体的上限：
...
<source id="mp4" src="https://learnopengl-cn.github.io/img/01/05/shaders.mp4" type="video/mp4">
</video>
...
![](./png/vertex_attribute_pointer_interleaved.png)
